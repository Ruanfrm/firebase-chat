  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        const imageStorageRef = storageRef(storage, `images/${selectedFile.name}`);
              ...
              >
                {messages.map((message, index) => (
                  ...
                  style={{
                    ...
                    backgroundColor: respondedMessage?.id === message.id ? '#f0f0f0' : 'transparent',
                  }}
                >
                    <Typography
                      variant="body1"
